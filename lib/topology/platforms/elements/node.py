...
from ..api import HighLevelShellAPI, LowLevelShellAPI, ServicesAPI, StateAPI
...
class BaseNode(
    HighLevelShellAPI, LowLevelShellAPI, ServicesAPI, StateAPI, BaseElement
):
    """
...
@add_metaclass(ABCMeta)
class CommonNode(CommonElement, BaseNode):
    """
