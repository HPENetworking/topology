# -*- coding: utf-8 -*-
#
# Docker Platform Engine for Topology documentation build configuration file.
#
...
htmlhelp_basename = 'topology_dockerdoc'
...
latex_documents = [
    (
        'index', 'topology_docker.tex',
        'Docker Platform Engine for Topology Documentation',
