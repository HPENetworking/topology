...
project = 'SSH/Telnet/etc connection Platform Engine for Topology'
...
htmlhelp_basename = 'topology_connectdoc'
...
latex_documents = [
    (
        'index', 'topology_connect.tex',
        'SSH/Telnet/etc connection Platform Engine for Topology Documentation',
